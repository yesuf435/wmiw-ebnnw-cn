...
class WechatAuth {
    ...
    private $requestCodeURL = 'https://wxht.xakaiku.cn/connect/oauth2/authorize';
    ...
    public function messageCustomSend($openid, $content, $type = self::MSG_TYPE_TEXT){
        ...
        return $this->api('message/custom/send', $data,'POST',array('access_token'=>$this->accessToken));
    ...
    public function sendNews(){
        // 获取传值去除空值
        $news   = array_filter(func_get_args());
